...
# ---------------------------------------------------------------------------
# Pure logic moved to core/engine.py — shim for backward compat (deleted in Phase 7)
# ---------------------------------------------------------------------------
from recipeparser.core.engine import deduplicate_recipes  # noqa: F401
...
# ---------------------------------------------------------------------------
# Cayenne pipeline moved to core/engine.py — shim for backward compat (deleted in Phase 7)
# ---------------------------------------------------------------------------
from recipeparser.core.engine import run_cayenne_pipeline  # noqa: F401



# ---------------------------------------------------------------------------
# FSM classes moved to core/fsm.py — shim for backward compat (deleted in Phase 7)
# ---------------------------------------------------------------------------
from recipeparser.core.fsm import (  # noqa: F401
    PipelineController,
    PipelineStatus,
    _TRANSITIONS,
)
